...
test('旧14列台帳を読み、保存用ヘッダーだけ三段階19列へ展開する',()=>{
  const additions=['引当段階','EMS到着予定日','現物確認日時','現物確認メモ','供給控除EMS'];
  assert.deepStrictEqual(JSON.parse(JSON.stringify(LEDGER_HEADERS.slice(-5))),additions);
