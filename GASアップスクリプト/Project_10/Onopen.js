 ...
 * シート名 → 設定オブジェクト マップ
 * ============================================================ */
function 設定をシート名で上書き_(cfg, シート名, 列名上書き) {
  const next = Object.assign({}, cfg, { マスターシート名: シート名 });
  next.列名 = Object.assign({}, cfg.列名, 列名上書き || {});
  return next;
}
...
function シート設定を取得(シート名) {
  const マップ = {
    ...
    '台湾まんが':                         設定をシート名で上書き_(設定_台湾書籍, '台湾まんが', { 商品コード: '親コード' }),
    '韓国マンガ':                         設定_韓国マンガ,
    '韓国書籍':                           設定_韓国書籍,
    '韓国音楽映像':                       設定_韓国音楽映像,
    '韓国グッズ':                         設定_韓国グッズ,
