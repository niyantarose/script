...
// GoQの注文ステータスは注文単位なので、分割発送済みでも問い合わせ中などに戻ることがある。
// P列も通常引当と同じく行単位の出荷日を事実として使い、発送済みの分割を再需要にしない。
function P列需要対象行_(row,M){ return !引当_行出荷済み_(row,M); }
